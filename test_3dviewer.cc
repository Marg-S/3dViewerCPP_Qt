...
TEST(TestReadScene, Test1) {
  ...
  viewer::NormalizationParameters parameters = facade.getParameters();
  viewer::NormalizationParameters expectedParameters{};
  for (int i = 0; i < 2; ++i) {
...
TEST(TestReadScene, Test2) {
  viewer::Facade facade("models/cat.obj");
...
TEST(TestMoveSceneCubeX, Test1) {
  viewer::Facade facade("models/cube.obj");
...
TEST(TestEqualPoints, Test1) {
  viewer::Point3d firstPoint(-122.049975, 177.452652, -71.317341);
  viewer::Point3d secondPoint(-122.049975, 177.452652, -71.317341);
  EXPECT_TRUE(firstPoint == secondPoint);
}

TEST(TestEqualPoints1, Test1) {
  viewer::Point3d firstPoint(-1342.049975, 157.452652, -731.317341);
  viewer::Point3d secondPoint(-1243.049975, 177.452652, -71.317341);
  EXPECT_FALSE(firstPoint == secondPoint);
}

TEST(CreateNewPoint, Test1) {
  viewer::Point3d firstPoint(-122.049975, 157.452652, -71.317341);
...
TEST(VertexEqual, Test1) {
  viewer::Point3d firstPoint(259.689121, 289.238756, 15.728211);
  viewer::Point3d secondPoint(259.689121, 289.238756, 15.728211);
  viewer::Vertex firstVertex(firstPoint);
  viewer::Vertex secondVertex(secondPoint);
  EXPECT_TRUE(firstVertex == secondVertex);
}

TEST(VertexEqual1, Test1) {
  viewer::Point3d firstPoint(259.689121, 289.238756, 15.728211);
  viewer::Point3d secondPoint(259.689121, 2849.238756, 135.728211);
  viewer::Vertex firstVertex(firstPoint);
  viewer::Vertex secondVertex(secondPoint);
...
TEST(FaceEquals, Test1) {
  ...
  viewer::Face firstFace(a1);
  viewer::Face secondFace(a2);
...
TEST(TestNormalization, Test1) {
  viewer::Facade facade("models/cube.obj", true);
